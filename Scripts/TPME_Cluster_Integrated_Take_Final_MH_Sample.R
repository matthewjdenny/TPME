Run_Sample_Step <- function(input_file = "Current_Itteration_McDowell_2011_3-7-14",data_source = "McDowell_2011_Data", output_file = "Sample_McDowell_2011_3-7-14", itterations = 1200000,sample_every = 100, data_directory = "~/Dropbox/PINLab/Projects/Denny_Working_Directory/2011_Analysis_Output/",sample_step_burnin = 200000,post_burin_variance_multiplier = 0.1, system_OS = "Linux", max_cpus = 20){
    
#     input_file = "Model_Output_New_Hannover_2011_4-30-14"
#     data_source = "New_Hannover_2011_Data"
#     output_file = "Sample_McDowell_2011_3-7-14"
#     itterations = 120000
#     sample_every = 100
#     data_directory = "~/Dropbox/PINLab/Projects/Denny_Working_Directory/2011_Analysis_Output/"
#     sample_step_burnin = 20000
...
#     max_cpus = 5
    ...
    Rcpp::sourceCpp("./Scripts/Test.cpp")
    ...
    Proposal_Variances <- rep(0.1,Clusters)
...
#     sfStop()
    ...
    Met_Res <- vector("list",length(Result_List[[1]]) )
    
    
    for(i in 1:(length(Met_Res)/3)){
        vect <- rep(0,num_clusters)
        for(j in 1:num_clusters){
            vect[j] <- Result_List[[j]][[i]]
        }
        print(vect)
        print(i)
        Met_Res[i] <- list(vect)
...
#     }
    ...
    Met_Res2 <- vector("list",length(Result_List[[1]]) )
