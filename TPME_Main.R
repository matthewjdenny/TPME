...
Generate_Model_Diagnsotics(input_file = "Sample_Step_New_Hannover_2011_3-13-14",LS_Actor = 8, out_directory = "~/Dropbox/PINLab/Projects/Denny_Working_Directory/2011_Analysis_Output/", vocab = vocabulary,county_name = "New_Hannover_County_Sample_1M_3-13-14", Thin_Itterations = 1,skip_first = 4000)
...
#Run_Sample_Step(input_file = "Current_Itteration_McDowell_2011_3-13-14",data_source = "McDowell_2011_Data", output_file = "McDowell_Sample_50M_2011_3-13-14", itterations = 50200000, proposal_variance = 0.25,sample_every = 5000,sample_step_burnin = 200000,post_burin_variance = 0.2, system_OS = "Linux", sampler = "Slice", slice_sample_step_size = 1)
...
#Run_Sample_Step(input_file = "Current_Itteration_Transylvania_2011_3-13-14",data_source = "Transylvania_2011_Data", output_file = "Transylvania_Sample_50M_2011_3-13-14", itterations = 50200000, proposal_variance = 0.1,sample_every = 1000,sample_step_burnin = 200000,post_burin_variance = 0.05, system_OS = "Linux", sampler = "Slice", slice_sample_step_size = 1)

#Run_Sample_Step(input_file = "Current_Itteration_New_Hannover_2011_3-14-14",data_source = "New_Hannover_2011_Data", output_file = "New_Hannover_Sample_50M_2011_3-14-14", itterations = 50200000, proposal_variance = 0.02,sample_every = 5000,sample_step_burnin = 200000,post_burin_variance = 0.01, system_OS = "Linux", sampler = "Slice", slice_sample_step_size = 1)
